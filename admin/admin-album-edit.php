...
$random_digit=rand(0000,9999);
 ...
 $image="thump";
 $filename=$_FILES["fileTothump"]["name"];
...
$idew=isset($_POST['idew']) ? $_POST['idew']:'';
 ...
 if (move_uploaded_file($_FILES["fileTothump"]["tmp_name"], $target_file)) {
	 $q="UPDATE `albums` SET `name`='$name',`thumb`='$target_file',`description`='$desc',`category`='$cat'  WHERE id='$idew'";
	 $a=$conn->query($q);
        echo "The file ". basename( $_FILES["fileToUpload"]["name"]). " has been uploaded.";
    } else {
		$q="UPDATE `albums` SET `name`='$name',`description`='$desc' ,`category`='$cat'  WHERE id='$idew'";
	 $a=$conn->query($q);
...
<?php 
$query="SELECT `id`,`name`,  `thumb`,  `description`,  `category` FROM `albums` where id='$id'";
$ca=$conn->query($query);
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="container">
                    <h3>Edit Album</h3>
                    <form class="event-form" action="admin-album-edit.php" method="post" enctype="multipart/form-data">
                        <div class="col-md-5 input-group">
                            <span class="input-group-addon">
                                <span style="color:#6b90ad">Name</span>
                            </span>
                            <input type="hidden" name="idew" value="<?php echo $cr['id']; ?>">
                            <input type="text" name="name" class="form-control" value="<?php echo $cr['name']; ?>"/>
                        </div>
                        <div class="col-md-5 input-group">
                            <span class="input-group-addon">
                                <span>Category</span>
                            ...
                            <input type="text" name="cat" class="form-control" list="person_list" value="<?php echo $cr['category']; ?>" onkeyup="checksales_man(this);"/>
                        ...
                        <div class="col-md-10 input-group">
                         ...
                         <img src="<?php echo $cr['thumb']; ?>" alt="Smiley face" height="42" width="42">
                        <div class="col-md-10 input-group">
                            <span class="input-group-addon">
