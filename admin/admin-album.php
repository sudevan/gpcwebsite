    ...
    <div class="responsive-navigation visible-sm visible-xs">
        ...
        <div class="responsive_menu">
            ...
            <ul class="social_icons">
                <li><a href="#"><span>logout.php</span><i class="fa fa-facebook"></i></a></li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="container">
                    <a href="admin-album-form.php"><button class="btn btn-primary">Create a ALBUM Entry</button></a>
                </div>
                    ...
                    <table class="table admin-list">
                       ...
                       <?php $i=$start+1;; foreach($result as $ca){?>
                        <tr>
                            ...
                            <td><?php echo $i; ?></td>
                            <td><?php echo substr($ca['name'],0,15) ?>....</td>
                            <td><img src="<?php echo $ca['thumb']; ?>" width="42" height="42"></td>
...
//alert(myvar);
'<%Session["temp"] = "' + myvar +'"; %>';
window.location="admin-album-edit.php?temp=" + myvar;
}
function edit1(e,id) {
...
//alert(myvar);
'<%Session["temp"] = "' + myvar +'"; %>';
window.location="admin-album-delete.php?temp=" + myvar;
}
</script>
</body>
</html>
