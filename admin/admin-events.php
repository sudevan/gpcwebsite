...
$search_keyword = '';
	...
	$sql = "SELECT `id`, DATE_FORMAT(date,'%d/%m/%Y') as date, `header`, `content`, `image` FROM `events` order by id desc";
    ...
    <div class="responsive-navigation visible-sm visible-xs">
        ...
        <div class="responsive_menu">
            <ul class="main_menu">
                ...
                <li class="active"><a href="admin-events.php">Events</a> </li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="container">
                    <a href="admin-event-form.php"><button class="btn btn-primary">Create a EVENTS Entry</button></a>
                </div>
...
//alert(myvar);
'<%Session["temp"] = "' + myvar +'"; %>';
window.location="admin-event-edit.php?temp=" + myvar;
}
</script>
</body>
</html>
