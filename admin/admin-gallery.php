    ...
    <div class="responsive-navigation visible-sm visible-xs">
        ...
        <div class="responsive_menu">
            <ul class="main_menu">
                ...
                <li><a href="admin-events.php">Events</a> </li> <li><a href="admin-ticker.php">Web ticker</a> </li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="container">
                    <a href="admin-gallery-form.php"><button class="btn btn-primary">Upload new photo Gallery</button></a>
                </div>
                ...
                <div class="container">
                    <table class="table admin-list">
                       ...
                       <?php $i=$start+1;; foreach($result as $ca){?>
                        <tr>
                            <td><?php echo $i; ?></td>
                            <td><img src=<?php echo $ca['thumb']; ?> height="42" width="42"></td>
...
<input type="hidden" name="id" id="id" value="<?php  echo $ca['id']; ?>" /><i class="fa fa-pencil" aria-hidden="true"></i></form></a> 
                            <a href="javascript:void(0)" onclick="edit1(this,'<?php echo $ca['id']; ?>')"><form method="get" action="saleinvoiceedit.php"><input type="hidden" name="txtedit_transaction" id="txtedit_transaction" value="0" />
<input type="hidden" name="id" id="id" value="<?php  echo $ca['id']; ?>" /><i class="fa fa-trash-o" aria-hidden="true"></i></form></a></td> </tr>
...
//alert(myvar);
'<%Session["temp"] = "' + myvar +'"; %>';
window.location="admin-gallery-edit.php?temp=" + myvar;
}
function edit1(e,id) {
...
//alert(myvar);
'<%Session["temp"] = "' + myvar +'"; %>';
window.location="admin-gallery-delete.php?temp=" + myvar;
}
</script>
</body>
</html>
