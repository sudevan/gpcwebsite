...
$random_digit=rand(0000,9999);
 $extension  = pathinfo($filename, PATHINFO_EXTENSION);$extension1  = pathinfo($filename1, PATHINFO_EXTENSION);

 $image1="thump";
$target_file = $target_dir.$image.$random_digit.'.'.$extension ;
$target_file1 = $target_dir.$image1.$random_digit.'.'.$extension1;
...
$default1="uploads/default.jpg";

 if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file) || move_uploaded_file($_FILES["fileTothump"]["tmp_name"], $target_file1)) {
	 $q="INSERT INTO `news`(  `date`, `header`, `content`,`content1`,`image`,`thumbnail`) VALUES ('$date','$header','$content','$content1','$target_file','$target_file1')";
	 $a=$conn->query($q);
	echo $q;
	exit;
        echo "The file ". basename( $_FILES["fileToUpload"]["name"]). " has been uploaded.";
    } else {
		 $q="INSERT INTO `news`(  `date`, `header`, `content`,`content1`,`image`,`thumbnail`) VALUES ('$date','$header','$content','$content1','$default','$default1')";
	 $a=$conn->query($q);
	 echo $q;
	 exit;
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="container">
                    <h3>New News</h3>
                    <form class="event-form" action="admin-news-form.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-10 input-group">
                            ...
                            <input type="text" name="header" id="" class="form-control" required />
                        </div>
                        <div class="col-md-10 input-group">
                            <span class="input-group-addon">
                        ...
                        <div class="col-md-10 input-group">
                            ...
                            <textarea class="form-control" name="content1"></textarea>
                        </div>
