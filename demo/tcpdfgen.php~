...
$filename=$datadirectory."/".$admno.".json";
if(file_exists($filename))
{
	...
	$new_birth_date = explode('/', $student->dob);
	...
	"Name of Educational Institution"=>$collegName,
	...
	"Date of Birth according to admission Register ( In figures and words )"=> "$student->dob ( $datewords )",
	...
	"Institution to which the pupil intends proceeding"=>proceedinginstitute,
