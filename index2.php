...
<div class="container">
  <div class="row" style=" ">
          <div class="col-sm-3"  id="nav" >
              <ul class="nav flex-column  sf-menu" style="background: #003a6a;       width: 250px">
                <li class="active"><a href="index.php">Home</a></li>
                <li><a href="news.php">News</a></li>
                <li><a href="events.php">Events</a></li>
                <li><a href="departments.html">Departments</a> </li>
              ...
              <div class="col-sm-9" style="border: 3px solid red;">
                            <div class="col-sm-12">
...
<div class="container">
        <div class="row"  style="background:#003a6a;">
            <div class="col-sm-12" >
                <div class="col-sm-6"style="border-right: 2px solid white;height: 188px" >

                    <center><h2 style="color: white">Vision</h2></center>
                     <font size="3" color="white" style="text-align: justify;"><ol type="1"><li>To be a centre of excellence in engineering education for providing valuable resources to industries and society.</li></ol>
                </font>
                    
                </div>
                
                 <div class="col-sm-6" style="border-left: 2px solid white">
                  <center>  <h2 style="color: white">Mission</h2></center>
