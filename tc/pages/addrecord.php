	...
	<section class="content">
      <div class="row">
        ...
        <div class="form-group">
            ...
            <input type="text" name="filenumber" id="filenumber" value="" class="form-control" onkeypress="return numeric(event)" width="50%" />
        </div> <!--div class="form-group"-->
          </div><!--div class="col-md-3"-->
        ...
        <div class="col-md-2">
        <div class="form-group">
            <label><span class="form-group">Tags</span></label>
            <textarea name='txtremark' id='txtremark' class='form-control' ></textarea>
        </div> <!--div class="form-group"-->
        </div><!--div class="col-md-3"-->
        ...
        <div class="form-group">
            <label></label>
            <input type="button" class="btn btn-block btn-success" value="Add" style="width:50% "  onclick="uptoallotaddRow('upto2')">
        </div> <!--div class="form-group"-->
